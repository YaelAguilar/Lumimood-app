...
class AppRouter {
  static final router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: '/diary', name: 'diary', builder: (context, state) => const DiaryPage()),
      ...
      GoRoute(path: '/create-note', name: 'create_note', builder: (context, state) => const CreateNotePage()),
      GoRoute(
        path: '/note-detail',
        name: 'note_detail',
        builder: (context, state) {
          if (state.extra is Note) return NoteDetailPage(note: state.extra as Note);
          return const NotesPage(); 
        },
      ),
      GoRoute(path: '/specialist-home', name: 'specialist_home', builder: (context, state) => const SpecialistHomePage()),
    ],
  );
}