              ...
              CustomButton(
                onPressed: () {
                  if (taskController.text.isNotEmpty) {
                    context.read<TasksBloc>().add(AddTask(taskController.text));
                  }
              ...
              Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text('Tus tareas', style: textTheme.labelMedium),
                  ),
                  Expanded(
                        ...
                        return Padding(
                          ...
                          child: Container(
                            ...
                            child: CheckboxListTile(
                              ...
                              onChanged: (_) => context.read<TasksBloc>().add(ToggleTaskCompletion(task.id)),
                              title: Text(task.title, style: textTheme.bodyLarge),
